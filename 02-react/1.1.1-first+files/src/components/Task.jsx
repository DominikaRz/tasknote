                        ...
                        <div className="uk-slider-container uk-light">
                            <div className="uk-slider-items uk-child-width-1-2 uk-child-width-1-3@s uk-child-width-1-3@m">
                                ...
                                <div key={index} className="uk-cover-container">
                                    ...
                                    {attach.type === 'IMAGE' && <img src={`/files/${attach.path}`} alt={attach.path} uk-cover="true" />}
                                    {attach.type === 'FILE' && (
                                    <iframe src={`/files/${attach.path}`} alt={attach.path} uk-responsive="true" uk-cover="true" uk-video="automute: true"></iframe>
                                    )}
                                    {attach.type === 'VOICE' && (
                                    <video src={`/files/${attach.path}`} alt={attach.path} uk-responsive="true" uk-cover="true" className="uk-position-center" uk-video="autoplay: false" poster="/img/play-button.svg" style={{ width: '2vw' }}></video>
                                    )}
                                </div>
                                ))}
                            </div>
